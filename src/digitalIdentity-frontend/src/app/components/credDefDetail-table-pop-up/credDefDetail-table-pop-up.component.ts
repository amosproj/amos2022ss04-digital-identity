...
export class CredDefDetailTablePopUpComponent implements OnInit {
  ...
  tableData: any[] = [];
  buttonFunctions: ((arg0: any, arg1: any, arg2: any) => void)[] = [
    this.showDetailsToCred,
  ];
  credDef: any;
  dataLoaded = false;

  constructor(
    public thisDialogRef: MatDialogRef<CredDefDetailTablePopUpComponent>,
    public dialogRef: MatDialog,
    @Inject(MAT_DIALOG_DATA)
    public data: { credDef: any; addDItoCredDef: () => void }
  ) {
