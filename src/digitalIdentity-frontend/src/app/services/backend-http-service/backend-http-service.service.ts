...
export class BackendHttpService {
  ...
  async postRequest(processName: string, path:string, data:any, params:HttpParams) : Promise<any> {
    let body = JSON.stringify(data)
    let promise = await new Promise<HttpResponse<any>>((resolve,reject) => (<Observable<HttpResponse<any>>>this.http
  ...
  async getRequest(processName: string, path:string, params:HttpParams) : Promise<any> {
    let promise = await new Promise<HttpResponse<any>>((resolve,reject) => (<Observable<HttpResponse<any>>>this.http
