...
public class ProofTemplateServiceTest {
    ...
    void defaultMocking() {
        ResponseEntity<String> responseEntity = new ResponseEntity<String>("anyString",
                HttpStatus.CREATED);
        Mockito.when(lissiApiService.createProofTemplate(anyString(), anyString(), anyString(), anyString(), any()))
    ...
    public void testCreateProofTemplateGeneric() {
        ...
        // Assert
        verify(lissiApiService).createProofTemplate(anyString(), anyString(), anyString(), anyString(), any());
    ...
    public void testCreateProofTemplateWrongFile() {
        ...
        // Assert
        verify(lissiApiService, never()).createProofTemplate(anyString(), anyString(), anyString(), anyString(), any());
